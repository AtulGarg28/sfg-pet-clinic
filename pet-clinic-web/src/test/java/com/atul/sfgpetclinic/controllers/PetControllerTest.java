...
class PetControllerTest {
    ...
    @Test
    void initAddNewPetTest() throws Exception {
    ...
    @Test
    void processAddNewPetTest() throws Exception {
        when(ownerService.findById(anyLong())).thenReturn(owner);
        when(petTypeService.findAll()).thenReturn(petTypes);
    ...
    @Test
    void initUpdatePetTest() throws Exception {
        when(ownerService.findById(anyLong())).thenReturn(owner);
        when(petTypeService.findAll()).thenReturn(petTypes);
    ...
    @Test
    void processUpdatePetTest() throws Exception {
        when(ownerService.findById(anyLong())).thenReturn(owner);
        when(petTypeService.findAll()).thenReturn(petTypes);
